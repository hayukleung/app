...
abstract class Action<T> {
    ...
    abstract void progress(int progress);

    abstract void complete(IImage result, Picasso.LoadedFrom from);
    ...
    static class RequestWeakReference<M> extends WeakReference<M> {
        final com.hayukleung.app.widget.media.picasso.Action action;

        public RequestWeakReference(com.hayukleung.app.widget.media.picasso.Action action, M referent, ReferenceQueue<? super M> q) {
            super(referent, q);
            this.action = action;
        }
    }
