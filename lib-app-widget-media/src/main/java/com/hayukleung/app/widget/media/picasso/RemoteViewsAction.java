...
abstract class RemoteViewsAction extends com.hayukleung.app.widget.media.picasso.Action<com.hayukleung.app.widget.media.picasso.RemoteViewsAction.RemoteViewsTarget> {
    ...
    void complete(IImage result, Picasso.LoadedFrom from) {
        if (result instanceof BitmapImage) {
            remoteViews.setImageViewBitmap(viewId, ((BitmapImage) result).getBitmap());
            update();
        } else {
            error();
        }
    ...
    static class AppWidgetAction extends com.hayukleung.app.widget.media.picasso.RemoteViewsAction {
    ...
    static class NotificationAction extends com.hayukleung.app.widget.media.picasso.RemoteViewsAction {
