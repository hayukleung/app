...
import com.hayukleung.app.widget.media.picasso.Picasso.Priority;
...
public final class Request {
     ...
     */
    public final List<com.hayukleung.app.widget.media.picasso.Transformation> transformations;
    /**
    ...
    /**
     * Scaling only if the source bitmap is larger than the target.
     */
    public final boolean onlyScaleDown;
    /**
     * Target image maxSize for resizing.
     */
    ...
    private Request(Uri uri, int resourceId, String stableKey, List<com.hayukleung.app.widget.media.picasso.Transformation> transformations,
                    int targetWidth, int targetHeight, boolean centerCrop, boolean centerInside, boolean onlyScaleDown,
                    int maxSize, boolean thumbnail, float rotationDegrees, float rotationPivotX, float rotationPivotY, boolean hasRotationPivot,
    ...
    public String toString() {
        ...
        if (transformations != null && !transformations.isEmpty()) {
            for (com.hayukleung.app.widget.media.picasso.Transformation transformation : transformations) {
    ...
    /**
     * Builder for creating {@link com.hayukleung.app.widget.media.picasso.Request} instances.
     */
    public static final class Builder {
        ...
        private List<com.hayukleung.app.widget.media.picasso.Transformation> transformations;
        ...
        private Builder(com.hayukleung.app.widget.media.picasso.Request request) {
            uri = request.uri;
         ...
         */
        public Builder transform(com.hayukleung.app.widget.media.picasso.Transformation transformation) {
        ...
        /**
         * Create the immutable {@link com.hayukleung.app.widget.media.picasso.Request} object.
         */
        public com.hayukleung.app.widget.media.picasso.Request build() {
            ...
            if (onlyScaleDown && (targetWidth == 0 || targetHeight == 0)) {
                throw new IllegalStateException(
                        "Only scale down requires calling resize with positive width and height.");
            }
            if (maxSize != 0) {
                ...
                if (targetWidth > maxSize) {
                    targetHeight = (int) Math.ceil(targetHeight * maxSize * 1f / targetWidth);
                    targetWidth = maxSize;
                }
                if (targetHeight > maxSize) {
                    targetWidth = (int) Math.ceil(targetWidth * maxSize * 1f / targetHeight);
            ...
            return new com.hayukleung.app.widget.media.picasso.Request(uri, resourceId, stableKey, transformations, targetWidth, targetHeight,
                    centerCrop, centerInside, onlyScaleDown, maxSize, thumbnail, rotationDegrees, rotationPivotX,
