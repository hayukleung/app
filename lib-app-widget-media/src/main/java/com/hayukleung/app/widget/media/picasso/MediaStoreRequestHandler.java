...
import static com.hayukleung.app.widget.media.picasso.MediaStoreRequestHandler.PicassoKind.FULL;
import static com.hayukleung.app.widget.media.picasso.MediaStoreRequestHandler.PicassoKind.MICRO;
import static com.hayukleung.app.widget.media.picasso.MediaStoreRequestHandler.PicassoKind.MINI;
    ...
    public IResource load(Request data) throws IOException {
        ...
        if (data.hasSize()) {
            ...
            if (!isVideo && picassoKind == FULL) {
                return new ContentStreamResource(context, data, exifOrientation);
            }
            ...
            if (bitmap != null) {
                return new BitmapResource(bitmap, DISK, exifOrientation);
            }
        }
