 ...
 * cache entries or cache journal. Unlike the {@link BufferedReader} which in conjunction
 * with {@link InputStreamReader} provides similar functionality, this class uses different
