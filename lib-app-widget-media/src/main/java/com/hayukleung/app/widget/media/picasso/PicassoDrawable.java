...
final class PicassoDrawable extends BitmapDrawable {
    ...
    static void setBitmap(ImageView target, Context context, Bitmap bitmap,
        ...
        com.hayukleung.app.widget.media.picasso.PicassoDrawable drawable =
                new com.hayukleung.app.widget.media.picasso.PicassoDrawable(context, bitmap, placeholder, loadedFrom, noFade, debugging);
