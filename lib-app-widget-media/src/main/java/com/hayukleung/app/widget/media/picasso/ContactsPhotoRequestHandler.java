...
class ContactsPhotoRequestHandler extends RequestHandler {
    ...
    public IResource load(Request data) throws IOException {
        return new ContactsResource(context, data);
    }

    private static class ContactsResource implements IResource {

        private Context context;
        private Request data;

        public ContactsResource(Context context, Request data) {
            this.context = context;
            this.data = data;
        }
        ...
        private IImage decode(Request data) throws IOException {
            IImage image = null;
        ...
        private Bitmap decodeStream(Request data) throws IOException {
            InputStream is;
