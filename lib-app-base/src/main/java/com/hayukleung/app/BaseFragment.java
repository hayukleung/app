...
public abstract class BaseFragment extends Fragment {
     ...
     * {@link com.hayukleung.app.base.R.id#progress_container R.id.progress_container}, content container whose id
     * is {@link com.hayukleung.app.base.R.id#content_container R.id.content_container} and can optionally have a
     ...
     * {@link com.hayukleung.app.base.R.layout#fragment_progress} in your layout file, so that you continue to
     * retain all of the standard behavior of BaseFragment. In particular, this is currently the only way to have
    ...
    /**
     * The default content for a BaseFragment has a TextView that can be shown when the content is empty
    ...
    public void showProgress(boolean animate) {
        ...
        View hiddenView = mProgressContainer;
    ...
    public void showError(boolean animate) {
        ...
        View hiddenView = mNetworkErrorContainer;
        switchView(shownView, hiddenView, animate);
    }
    ...
    public void showContent(boolean animate) {
        ...
        View hiddenView = mContentContainer;
        switchView(shownView, hiddenView, animate);
    }
    ...
    private void switchView(View shownView, View hiddenView, boolean animate) {
        if (animate) {
            ...
            hiddenView.startAnimation(AnimationUtils.loadAnimation(getActivity(), android.R.anim.fade_in));
        } else {
