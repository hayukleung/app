package com.hayukleung.app.view.recyclerView;
...
public class QuickReturnOnScrollListener extends RecyclerView.OnScrollListener {
                ...
                for (Item item : mFooterViews) {
                    ...
                    if (diff > item.mScrollThreshold) {
                        if (item.mUpAnimator == null || !item.mUpAnimator.isStarted()) {
                            ...
                            item.mUpAnimator = ObjectAnimator.ofFloat(view, "translationY", ViewHelper.getTranslationY(view), item.mDistance);
                            item.mUpAnimator.setDuration(item.mAnimationDuration).start();
                        }
                    }
                }
                ...
                for (Item item : mHeaderViews) {
                    ...
                    if (diff < -item.mScrollThreshold) {
                        if (item.mDownAnimator == null || !item.mDownAnimator.isStarted()) {
                            ...
                            item.mDownAnimator = ObjectAnimator.ofFloat(view, "translationY", ViewHelper.getTranslationY(view), 0);
    ...
    public void unregisterExtraOnScrollListener(RecyclerView.OnScrollListener listener) {
        mExtraOnScrollListeners.remove(listener);
    }
    ...
    public static class Item {
        ...
        public Item(View view, int minTranslation, int scrollThreshold, int distance, int animationDuration) {
            this.mView = view;
