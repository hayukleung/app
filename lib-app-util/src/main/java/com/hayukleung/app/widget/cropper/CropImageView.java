...
package com.hayukleung.app.widget.cropper;
...
import com.hayukleung.app.widget.cropper.cropwindow.CropOverlayView;
import com.hayukleung.app.widget.cropper.cropwindow.edge.Edge;
import com.hayukleung.app.widget.cropper.util.ImageViewUtil;
...
public class CropImageView extends FrameLayout {
    ...
    private void init(Context context) {
        ...
        final View v = inflater.inflate(R.layout.layout_crop_image_view, this, true);
