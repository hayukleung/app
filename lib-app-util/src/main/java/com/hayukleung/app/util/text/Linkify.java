...
//        }
        ...
        for (LinkSpec link : links) {
            applyLink(link.url, link.start, link.end, text, null);
        }
    ...
    public static final void addLinks(TextView text, Pattern p, String scheme,
                                      MatchFilter matchFilter, TransformFilter transformFilter, com.hayukleung.app.util.text.URLSpan.SpanCreator spanCreator) {
        SpannableString s = SpannableString.valueOf(text.getText());

        if (addLinks(s, p, scheme, matchFilter, transformFilter, spanCreator)) {
            text.setText(s);
            addLinkMovementMethod(text);
        }
    }
     ...
     * @param pattern Regex pattern to be used for finding links
     * @param scheme Url scheme string (eg <code>http://</code> to be prepended to the url of links that do not have
     * @param spanCreator
     * @return
     */
    public static final boolean addLinks(Spannable text, Pattern pattern, String scheme, com.hayukleung.app.util.text.URLSpan.SpanCreator spanCreator) {
        return addLinks(text, pattern, scheme, null, null, spanCreator);
    }
     ...
     * @return
     */
    public static final boolean addLinks(Spannable text, Pattern pattern, String scheme, MatchFilter matchFilter, com.hayukleung.app.util.text.URLSpan.SpanCreator spanCreator) {
        return addLinks(text, pattern, scheme, matchFilter, null, spanCreator);
    }
     ...
     * @return
     */
    public static final boolean addLinks(Spannable text, Pattern pattern, String scheme, TransformFilter transformFilter, com.hayukleung.app.util.text.URLSpan.SpanCreator spanCreator) {
        return addLinks(text, pattern, scheme, null, transformFilter, spanCreator);
    }
     ...
     * @param p Regex pattern to be used for finding links
     * @param scheme Url scheme string (eg <code>http://</code> to be prepended to the url of links that do not have a scheme specified in the link text
    ...
    public static final boolean addLinks(Spannable s,
                                         ...
                                         com.hayukleung.app.util.text.URLSpan.SpanCreator spanCreator) {
        ...
        while (m.find()) {
            ...
            if (allowed) {
                ...
                applyLink(url, start, end, s, spanCreator);
                hasMatches = true;
            }
        }
    ...
    private static final void applyLink(String url, int start, int end, Spannable text, com.hayukleung.app.util.text.URLSpan.SpanCreator spanCreator) {
        URLSpan span;
        if (spanCreator != null) {
            span = spanCreator.create(url);
        } else {
