...
public class RegexConstant {
     ...
     * ......
     */
    public static final String REG_CTX_PHONE = "((1[- ]?[3,4,5,7,8])(([- ]?\\d{1})){9})|106\\d{5,10}|\\d{5}|0\\d{2}[- ]?\\d{8}|\\(0\\d{2}\\)[- ]?\\d{8}|0\\d{3}[- ]?\\d{7}|\\(0\\d{3}\\)[- ]?\\d{7}";
     ...
     * 链接地址（全文匹配）
     */
    public static final String REG_CTX_URL = "(([h,H][t,T][t,T][p,P][s,S]?|[f,F][t,T][p,P]|[r,R][t,T][s,S][p,P]|[m,M][m,M][s,S])://)?(([0-9a-zA-Z_!~*'().&=+$%-]+:)?[0-9a-zA-Z_!~*'().&=+$%-]+@)?(([0-9]{1,3}\\.){3}[0-9]{1,3}|([0-9a-zA-Z_!~*'()-]+\\.)*([0-9a-zA-Z][0-9a-z-A-Z-]{0,61})?[0-9a-zA-Z]\\.[a-zA-Z]{2,6})(:[0-9]{1,4})?((/?)|(/[0-9a-zA-Z_!~*'().;?:@&=+$,%#-]+)+/?)";
