...
public class DevicePolicyActivity extends PermissionsRequiredActivity implements Observer {
  ...
  @BindView(R.id.Activation) Button mActivation;
  @BindView(R.id.Deactivation) Button mDeactivation;
  @BindView(R.id.Lock) Button mLock;
  ...
  @Override protected String[] requiredPermissions() {
    // 无需检测权限
    return new String[0];
  }
  ...
  @OnClick({
      R.id.Activation, R.id.Deactivation, R.id.Lock
