...
public class NetworkDispatcher extends Dispatcher {
     ...
     */
    private final BlockingQueue<NetworkTask> mQueue;
    /**
     ...
     */
    public NetworkDispatcher(BlockingQueue<NetworkTask> queue, Network network, Cache cache, ResponseDelivery delivery) {
        mQueue = queue;
        mNetwork = network;
        mCache = cache;
        mDelivery = delivery;
    ...
    private void parseAndDeliverNetworkError(NetworkTask request, VolleyError error) {
