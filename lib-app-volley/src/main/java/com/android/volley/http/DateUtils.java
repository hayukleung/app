...
public final class DateUtils {
    ...
    /**
     * A factory for {@link java.text.SimpleDateFormat}s. The instances are stored in a threadlocal way because SimpleDateFormat
     * is not threadsafe as noted in {@link java.text.SimpleDateFormat its javadoc}.
     */
    final static class DateFormatHolder {
        ...
        /**
         * creates a {@link java.text.SimpleDateFormat} for the requested format string.
         *
         * @param pattern a non-<code>null</code> format String according to {@link java.text.SimpleDateFormat}. The format is not
         ...
         * {@link java.text.SimpleDateFormat#applyPattern(String) apply} to a different pattern.
         */
