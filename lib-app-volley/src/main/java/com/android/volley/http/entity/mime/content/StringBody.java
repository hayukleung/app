...
package com.android.volley.http.entity.mime.content;

import com.android.volley.http.HTTP;
import com.android.volley.http.entity.mime.MIME;
...
public class StringBody extends AbstractContentBody {
    ...
    public static StringBody create(final String text) throws IllegalArgumentException {
        try {
            ...
            // Impossible
            throw new IllegalArgumentException("Charset is not supported", ex);
        }
    }
